...
enum class HypercallNumber : unsigned __int32 {
  ...
  kEnableVmmDeviceMonitor,
  kDisableVmmDeviceMonitor,
  kMaximumHypercallNumber = kDisableVmmDeviceMonitor,
};
...
/// ExFreePoolWithTag(dpc, kDeviceMonCommonPoolTag).
...
void   WritePCIByte(UINT32 pci_reg, UINT16 cfg_data_port, UINT8  byte_value);
void   WritePCIWord(UINT32 pci_reg, UINT16 cfg_data_port, UINT16 word_value);
void   WritePCIDword(UINT32 pci_reg, UINT16 cfg_data_port, UINT32 dword_value);
UINT8  ReadPCIByte(UINT32 pci_reg, UINT16 cfg_data_port);
UINT16 ReadPCIWord(UINT32 pci_reg, UINT16 cfg_data_port);
UINT32 ReadPCIDword(UINT32 pci_reg, UINT16 cfg_data_port);
