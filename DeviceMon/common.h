...
/// @mainpage
/// @section whats About
/// These pages serve as a programmer's reference manual for DeviceMon and
/// were automatically generated from the source using Doxygen.
///
/// For compilation and installation of DeviceMon, see the DeviceMon
/// project page. For more general information about development using
/// DeviceMon, see User's Documents in the project page.
/// @li https://github.com/tandasat/DeviceMon
///
...
/// point
/// of DeviceMon, and the VmmVmExitHandler() function, a high-level entry
...
#define HYPERPLATFORM_COMMON_BUG_CHECK(hp_bug_check_code, param1, param2,    \
  ...
  const DeviceMonBugCheck code = (hp_bug_check_code);                    \
...
/// A pool tag
static const ULONG kDeviceMonCommonPoolTag = 'PpyH';
...
enum class DeviceMonBugCheck : ULONG {
